...
void fs_seed_home(void) {
    ...
    /* The user's home directory (where logins start, shown as ~).
       home.tar cannot reliably carry empty directories, so /home/home
       is created here - after every init/seed, including datareset's
       factory restore. */
    if (!fs_directory_exists("/home"))
        fs_create_directory("/home");
    if (!fs_directory_exists("/home/home"))
        fs_create_directory("/home/home");

    /* Standard user folders under ~, for the same reason as /home/home
       ...
       factory restore. */
    {
        ...
        for (i = 0; i < 5; i++) {
            char p[FS_PATH_CAP];
            int len = strlen_safe("/home/home/");
            strcpy_safe(p, "/home/home/", sizeof(p));
